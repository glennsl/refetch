...
function _stringifyPayload(param) {
  ...
  if (variant >= 781815140) {
    ...
    return Rebase.List[/* reduce */0]((function (acc, p) {
                  return "\n" + acc + p;
                }), "--" + (String(boundary) + "\n"), Rebase.List[/* map */2]((function (param) {
                      var headers = Rebase.List[/* reduce */0]((function (acc, h) {
                              return acc + h + "\n";
                            }), "", Rebase.List[/* map */2](Refetch__Headers._stringifyHeader, param[0]));
...
function _toFetchRequest(request) {
  return new Request(_buildUrl(request[/* url */0], request[/* queryParams */2]), Fetch.RequestInit[/* make */0](/* Some */[_encodeMethod(request[/* method */1])], /* Some */[Refetch__Headers._encode(Rebase.List[/* reverse */14](request[/* headers */3]))], Rebase.Option[/* map */2](_stringifyPayload, request[/* body */4]), /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0)(/* () */0));
}
