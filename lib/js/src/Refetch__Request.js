...
function _buildUrl(url, params) {
  ...
  var joinParams = function (params) {
    return Refetch__Utils.List[/* reduceOr */0]("", (function (acc, param) {
                  return "" + (String(acc) + ("&" + (String(param) + "")));
                }), params);
  };
  var params$1 = joinParams(Rebase.List[/* map */0](encodeParam, params));
...
function _stringifyPayload(param) {
  ...
  if (variant >= 781815140) {
    if (variant >= 826371656) {
      ...
      return Refetch__Utils.List[/* reduceOr */0]("", (function (acc, item) {
...
function _toFetchRequest(request) {
  return new Request(_buildUrl(request[/* url */0], request[/* queryParams */2]), Fetch.RequestInit[/* make */0](/* Some */[_encodeMethod(request[/* method */1])], /* Some */[Refetch__Headers._encode(Rebase.List[/* reverse */20](request[/* headers */3]))], Rebase.Option[/* map */0](_stringifyPayload, request[/* body */4]), /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* () */0));
}
