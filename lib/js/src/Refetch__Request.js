...
function _toFetchRequest(request) {
  return new Request(_buildUrl(request[/* url */0], request[/* queryParams */2]), Fetch.RequestInit[/* make */0](/* Some */[_encodeMethod(request[/* method */1])], /* Some */[Refetch__Headers._encode(Rebase.List[/* reverse */14](request[/* headers */3]))], Rebase.Option[/* map */2]((function (param) {
                          var variant = param[0];
                          if (variant !== 781815140) {
                            if (variant >= 826371656) {
