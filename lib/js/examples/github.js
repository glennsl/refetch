...
function columnify(rows) {
  var param = Rebase.List[/* map */2]((function (columns) {
          return Rebase.List[/* map */2](Rebase.$$String[/* length */0], columns);
        }), rows);
  var maxLengths = param ? Rebase.List[/* reduce */0]((function (maxs, lengths) {
            return Rebase.List[/* map */2]((function (param) {
                        ...
                        }), Rebase.List[/* zip */15](maxs, lengths));
          }), param[0], param[1]) : /* [] */0;
  return Rebase.List[/* map */2]((function (columns) {
                return Rebase.List[/* reduce */0]((function (s, c) {
                              return s + " " + c;
                            }), "", Rebase.List[/* map */2]((function (param) {
                                  return Rebase.$$String[/* padEnd */7](param[0], " ", param[1]);
                                }), Rebase.List[/* zip */15](maxLengths, columns)));
              }), rows);
}
...
function printRepos(repos) {
  ...
  return Rebase.List[/* forEach */8]((function (param) {
                ...
                console.log("");
                return /* () */0;
              }), Rebase.List[/* zip */15](headers, stats));
}
