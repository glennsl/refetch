            ...
            if (param.tag) {
              ...
              return Refetch__Response.text(param[1]);
                  ...
                  Json_encode.object_(/* :: */[
                      ...
                      246273139,
                      "application/json"
                    ], Refetch__Request.header(/* `Authorization */[
                          826042841,
                          /* `Bearer */[
                            -881134847,
                            "jklcolid"
                          ]
                        ], Refetch__Request.basicAuthentication("boo", "yah", Refetch__Request.param("filter", "foo=true", Refetch__Request.param("sort", "DESC", Refetch.request(/* POST */891112544, /* None */0, /* None */0, /* None */0, "http://putsreq.com/FFB540W0YeOnQjBMOKVq"))))))))));
